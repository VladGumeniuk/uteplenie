...
/* harmony import */ var _vendor_our_works_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../vendor/our-works.js */ "./src/js/vendor/our-works.js");
/* harmony import */ var _vendor_reviews_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../vendor/reviews.js */ "./src/js/vendor/reviews.js");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   our_works: () => (/* binding */ our_works)
/* harmony export */ });
const our_works = [{
  id: 1,
...
const reviews = [{
  id: 1,
  name: "Дмитро",
  text: "Професійно виконані роботи з утеплення фасаду. Відчутна енергоефективність і зниження витрат на опалення."
}, {
  id: 2,
  name: "Олена",
  text: "Компанія вражає своєю організованістю і якістю робіт. Значне поліпшення температурного комфорту в будинку."
}, {
  id: 3,
  name: "Катерина",
  text: "Професійна команда виконала утеплення фасаду на високому рівні. Рекомендую всім, хто прагне знизити витрати на енергію."
}, {
  id: 4,
  name: "Сергій",
  text: "Утеплення фасаду виявилося вдалим рішенням для нашого будинку. Тепер відчутно зменшилися температурні коливання всередині."
}, {
  id: 5,
  name: "Анатолій",
  text: "Задоволений результатом робіт з утеплення фасаду. Відмінна якість і швидке виконання."
}, {
  id: 6,
  name: "Оксана",
